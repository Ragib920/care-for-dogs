        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Help Post List</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Recent help post</a></li>
                    ...
                    <thead class="thead-dark">
                        ...
                        @foreach ($post as $post)
                            <tr>
                                ...
                                <th><button type="button" class="btn btn-warning">Request Accepted</button></th>
                                <th></th>
                                <th><button type="button" class="btn btn-success">Donation Reached</button></th>
                            </tr>
                        @endforeach
                        </tbody> 
                    </table>
