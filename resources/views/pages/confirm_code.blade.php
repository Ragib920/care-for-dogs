                ...
                <div class="col-md-4">
                    ...
                    <div class="wrapper border">
                        <form class="form-signin border p-3 clearfix">
                            <h2 class="form-signin-heading d-flex justify-content-center pb-5">Enter Code</h2>
                            <p class="text-primary float-left">you got a 4-digit code through your gmail</p>
                            <div class="pt-2">
                                <input type="text" class="form-control" name="username" placeholder=" 4 -digit-Code" required="" autofocus="" />
                            </div>
                            <div class="pt-3 pb-4 ">
