            ...
            <div class="row justify-content-center">
                <div class="col-xs-6">
                    ...
                    <form class="border p-4">
                        <p class="d-flex justify-content-center h4 pb-4">Sign Up Form</p>
                            ...
                            <div class="form-group col-md-6">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="#">Mohommadpur</a>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-group">
                            <p class="d-inline pr-3">Register as a proud</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Enter your Full Name"required>
                        </div>
                        <div class="form-group">
