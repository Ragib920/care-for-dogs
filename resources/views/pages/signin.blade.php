                ...
                <div class="col-md-4">
                    ...
                    <div class="wrapper border">
                        <form class="form-signin border p-3 clearfix">
                            <h2 class="form-signin-heading d-flex justify-content-center pb-5">Sign in</h2>
                            <div class="pt-2">
                            ...
                            <a class="text-primary float-left pt-4" href="{{ url('signup')}}">New here? Sign up now</a>
                            <a class="text-danger float-right pt-4 pb-2" href="{{ url('forgot_password.html')}}" >Fogot Password</a>
                        </form>
                    </div>
                </div>
